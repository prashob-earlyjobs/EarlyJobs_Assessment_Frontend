        ...
        <main className="max-w-7xl mx-auto px-6 lg:px-12 py-20 flex-1">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
              Discover your strengths, build an AI-optimized resume, get
              personalized career guidance, and apply to multiple jobs
              effortlessly. Your dream job is just a click away!
            </p>
          ...
          >
            <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Showcase your expertise with comprehensive, AI-driven skill
                assessments and earn verified badges.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Receive personalized career advice, role recommendations, and
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Apply to 10, 20, 50, or 100 jobs at once with a single click,
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              {/* <div className="mt-2 flex items-start gap-2">
                ...
                <span>
                  53, HustleHub, 5th Cross Rd, near Sony World Signal,
                  <br />
