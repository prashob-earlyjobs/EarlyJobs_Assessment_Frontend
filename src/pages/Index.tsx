  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Take AI-powered skill assessments, build your digital passport, and connect with top employers. EarlyJobs streamlines hiring for job seekers and companies." />
      </Helmet>
